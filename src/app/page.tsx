                ...
                <div className="mb-4">
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <button
                                className="cursor-pointer bg-blue-200 hover:bg-blue-300 py-1 px-2 rounded-lg text-sm">All
                            </button>
                            <button
                                className="bg-green-200 hover:bg-green-300 py-1 px-2 rounded-lg text-sm cursor-pointer">Completed
                            </button>
                            <button
                                className="bg-yellow-200 hover:bg-yellow-300 py-1 px-2 rounded-lg text-sm cursor-pointer">Pending
                            </button>
                            <a
                                className="bg-indigo-200 hover:bg-indigo-300 py-1 px-2 rounded-lg text-sm cursor-pointer">Design</a>
                            <a
                                className="bg-purple-200 hover:bg-purple-300 py-1 px-2 rounded-lg text-sm cursor-pointer">AI</a>
                            <a className="bg-pink-200 hover:bg-pink-300 py-1 px-2 rounded-lg text-sm cursor-pointer">Machine
                                Learning</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="overflow-hidden  border rounded-lg border-gray-300">
                                <table className="table-auto min-w-full rounded-xl">
                                    ...
                                    <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                                        ...
                                        <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                            <span
                                                className="border-2 border-red-300 bg-red-300 rounded-xl px-2 py-1 text-xs font-medium">
                                                High
                                            </span>
                                        </td>
                                        <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                            <div
                                                className="py-1.5 px-2.5 bg-emerald-50 rounded-full flex justify-center w-20 items-center gap-1">
                                                <p className="font-medium text-xs text-emerald-600 ">Completed</p>
                                            </div>
                                        </td>
