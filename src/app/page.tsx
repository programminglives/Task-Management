...
export default function Home() {
    ...
    const handleCompletedEvent = (id: string | null) => {
        if (confirm("Are you sure this task is completed?")) {
            const completedTask = tasks.find((task: Task) => task.id === id);
            const otherTasks = tasks.filter((task: Task) => task.id !== id);
            if (completedTask) {
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <button onClick={() => setStatusFilter("all")}
                                    ...
                                    {statusFilter !== Status.PENDING && statusFilter !== Status.COMPLETED ? '✔' : ''} ️All
                                </button>
                            ...
                            <div className="overflow-hidden  border rounded-lg border-gray-300">
                                <table className="table-auto min-w-full rounded-xl">
                                    ...
                                    <tr className="bg-gray-50">
                                        ...
                                        {/*</th>*/}
                                        <th scope="col"
                                            className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Title
                                        </th>
                                        <th scope="col"
                                            className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Description
                                        </th>
                                        <th scope="col"
                                            className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize min-w-[150px]"> Due
                                            Date
                                        </th>
                                        <th scope="col"
                                            className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Priority
                                        </th>
                                        <th scope="col"
                                            className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Status
                                        </th>
                                        <th scope="col"
                                            className="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize"> Actions
                                        </th>
                                    </tr>
                                    </thead>
                                                    ...
                                                    <td className="flex p-5 items-center gap-0.5">
                                                        {
                                                            task.status == Status.PENDING && (
                                                                <button onClick={() => handleCompletedEvent(task.id)}
                                                                        className="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-green-500 flex center cursor-pointer">
                                                                    <svg className="" width="20" height="20" viewBox="0 0 20 20"
                                                                         fill="none"  /* SVG container itself has no fill */
                                                                         xmlns="http://www.w3.org/2000/svg">
                                                                        <path className="fill-green-600 group-hover:fill-white"
                                                                              fillRule="evenodd"
                                                                              clipRule="evenodd"
                                                        ...
                                                        <button data-id={task.id} onClick={handleDeleteEvent}
                                                            ...
                                                            <svg className="" width="20" height="20" viewBox="0 0 20 20"
                                                                 fill="none"
                                                                 xmlns="http://www.w3.org/2000/svg">
                                                                <path className="fill-red-600 group-hover:fill-white"
                                                        ...
                                                        {/*        <path className="fill-indigo-500 group-hover:fill-white"*/}
